...
// Auto-generated page for: Family tree + biography auto-completion pulling census, immi

export default function CfFamilyTreeBiographyAutoCompletionPu() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-family-tree-biography-auto-completion-pu', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Family tree + biography auto-completion pulling census, immi</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Family tree + biography auto-completion pulling census, immigration, military public records.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Family tree + biography auto-completion pulling census, immi'}
        </button>
      </form>
