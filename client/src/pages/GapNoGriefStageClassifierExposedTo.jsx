...
// Auto-generated page for: No grief-stage classifier exposed to families

export default function GapNoGriefStageClassifierExposedTo() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-grief-stage-classifier-exposed-to', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No grief-stage classifier exposed to families</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No grief-stage classifier exposed to families</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No grief-stage classifier exposed to families'}
        </button>
      </form>
