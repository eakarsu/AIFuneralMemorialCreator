...
// Auto-generated page for: No timeline-narrative synthesis (weave life events + photos)

export default function GapNoTimelineNarrativeSynthesisWeaveLi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-timeline-narrative-synthesis-weave-li', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No timeline-narrative synthesis (weave life events + photos)</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No timeline-narrative synthesis (weave life events + photos)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No timeline-narrative synthesis (weave life events + photos)'}
        </button>
      </form>
