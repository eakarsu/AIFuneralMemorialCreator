...
// Auto-generated page for: Multi-modal memorial video generation (eulogy audio, photo t

export default function CfMultiModalMemorialVideoGenerationEu() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-multi-modal-memorial-video-generation-eu', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Multi-modal memorial video generation (eulogy audio, photo t</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Multi-modal memorial video generation (eulogy audio, photo transitions, voiceover) from minimal family input.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Multi-modal memorial video generation (eulogy audio, photo t'}
        </button>
      </form>
