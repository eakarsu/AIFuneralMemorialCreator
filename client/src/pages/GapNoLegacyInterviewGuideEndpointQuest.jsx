...
// Auto-generated page for: No legacy-interview-guide endpoint (questions to interview f

export default function GapNoLegacyInterviewGuideEndpointQuest() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-legacy-interview-guide-endpoint-quest', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No legacy-interview-guide endpoint (questions to interview f</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No legacy-interview-guide endpoint (questions to interview family)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No legacy-interview-guide endpoint (questions to interview f'}
        </button>
      </form>
