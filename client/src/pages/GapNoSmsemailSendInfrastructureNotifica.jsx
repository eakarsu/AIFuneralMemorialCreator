...
// Auto-generated page for: No SMS/email send infrastructure (notification module limite

export default function GapNoSmsemailSendInfrastructureNotifica() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-smsemail-send-infrastructure-notifica', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No SMS/email send infrastructure (notification module limite</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No SMS/email send infrastructure (notification module limited)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No SMS/email send infrastructure (notification module limite'}
        </button>
      </form>
