...
// Auto-generated page for: Probate assistant adding state-specific checklists, deadline

export default function CfProbateAssistantAddingStateSpecific() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-probate-assistant-adding-state-specific-', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Probate assistant adding state-specific checklists, deadline</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Probate assistant adding state-specific checklists, deadlines, and document templates atop existing probate route.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Probate assistant adding state-specific checklists, deadline'}
        </button>
      </form>
