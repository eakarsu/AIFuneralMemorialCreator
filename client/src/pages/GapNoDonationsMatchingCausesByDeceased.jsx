...
// Auto-generated page for: No donations-matching (causes by deceased values)

export default function GapNoDonationsMatchingCausesByDeceased() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-donations-matching-causes-by-deceased', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No donations-matching (causes by deceased values)</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No donations-matching (causes by deceased values)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No donations-matching (causes by deceased values)'}
        </button>
      </form>
