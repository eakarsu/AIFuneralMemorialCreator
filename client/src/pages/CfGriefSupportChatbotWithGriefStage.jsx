...
// Auto-generated page for: Grief support chatbot with grief-stage detection and escalat

export default function CfGriefSupportChatbotWithGriefStage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-grief-support-chatbot-with-grief-stage', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Grief support chatbot with grief-stage detection and escalat</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Grief support chatbot with grief-stage detection and escalation to licensed counselors.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Grief support chatbot with grief-stage detection and escalat'}
        </button>
      </form>
