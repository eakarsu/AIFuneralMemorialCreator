...
// Auto-generated page for: Legacy giving advisor matching memorial funds to causes and 

export default function CfLegacyGivingAdvisorMatchingMemorial() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-legacy-giving-advisor-matching-memorial-', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Legacy giving advisor matching memorial funds to causes and </h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Legacy giving advisor matching memorial funds to causes and tracking corporate matching contributions.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Legacy giving advisor matching memorial funds to causes and '}
        </button>
      </form>
